...
> **2026-05-10 update — M6 closed.** Done: 1.1, 1.3, 1.4, 1.5, 1.6, 1.7, 2.4, 2.5, 2.9, 2.10, 3.5. Deferred: 1.2 (needs domain). See `docs/MILESTONE_6_VERIFICATION.md`. Next: M7 (2.1, 2.2, 2.3).
