...
const nextConfig: NextConfig = {
  ...
  // jsdom + @mozilla/readability (M8.C URL ingest): heavy native-ish deps
  // that Vercel's bundler chokes on at module-init time when bundled. Mark
  // them external so they're loaded from node_modules at runtime.
